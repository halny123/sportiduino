...
#ifdef HW_YU  // Определяем ноги под свою плату если они не совпадают с Sportiduino
...
const uint8_t LED =     4;   // led diod pin 4
const uint8_t BUZ =     3;   // buzzer pin 3
...
void loop ()
{
 ...
 // --------------- NRF24l01 Проверяем есть ли на модуле питание если да то входим в режим конфигурирования через радиомодуль
 rf24();
 // --------------- NRF24l01 ---
...
void rf24(){
 while (digitalRead(VCC_NRF)){                                    // Крутимся в цикле пока не снимем питание с радиомодуля
...
// При возникновении прерывания по входу на PD7 перегружаемся
