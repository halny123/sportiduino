h1 Небольшое описание того как отметку делал я и какие возникли нюансы.
...
h2 По компонентам, что использовал и выводы:
...
h2 Библиотека для NRF
https://github.com/TMRh20

------------------------------------------------
h2 Наглядное видео работы:
